        ...
        child: Stack(
          children: [
            Positioned(
              bottom: 0,
              left: 0,
              child: Opacity(opacity: 0.1,child: Image.asset("assets/images/repair.png",fit: BoxFit.cover,))),
                          ...
                          Container(
                            ...
                            child: Row(
                              children: const [
                                ...
                                Icon(Icons.speaker,size: 26,color: Colors.grey,)
                              ],
                            ),
                          )
                        ],
                            ...
                            child: Row(
                              children: const [
                                OfferCard(
                                  ...
                                  description: "Cashback 5% from each repair",
                            ...
                            child: IndexedStack(
                              ...
                              children:  [
                                ...
                                Container(
                                  ...
                                  width: double.maxFinite,
                                  height: 200,
                                  child: const Text('Kitchen',style: TextStyle(fontSize: 24,fontFamily: "Gotham",fontWeight: FontWeight.w600),),
                                ),
                                Container(
                                  alignment: Alignment.center,
                                  width: double.maxFinite,
                                  height: 200,
                                  child: const Text('Livingroom',style: TextStyle(fontSize: 24,fontFamily: "Gotham",fontWeight: FontWeight.w600),),
                                ),
                                Container(
                                  alignment: Alignment.center,
                                  width: double.maxFinite,
                                  height: 200,
                                  child: const Text('Bathroom',style: TextStyle(fontSize: 24,fontFamily: "Gotham",fontWeight: FontWeight.w600),),
                                ),
                              ],
                            ),
                          ),
...
class Offers extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
        children: index == 0 ?  List.generate(list.length, (index) {
      return ListCustom(
